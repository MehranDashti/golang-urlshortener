...
func (m *mockURLRepoCSV) Create(ctx context.Context, url *model.URL) error {
	m.created = append(m.created, url)
	return nil
}
func (m *mockURLRepoCSV) FindAll(ctx context.Context) ([]*model.URL, error) {
	return m.urls, nil
}
func (m *mockURLRepoCSV) FindByShortCode(ctx context.Context, code string) (*model.URL, error) {
	return nil, nil
}
func (m *mockURLRepoCSV) IncrementClicks(ctx context.Context, id string) error { return nil }
func (m *mockURLRepoCSV) FindByUserID(ctx context.Context, userID string) ([]*model.URL, error) {
	return nil, nil
}
...
func TestWriteLinksCSV(t *testing.T) {
	urls := []*model.URL{
		{ID: "1", ShortCode: "abc123", OriginalURL: "https://google.com", Clicks: 5},
		{ID: "2", ShortCode: "def456", OriginalURL: "https://github.com", Clicks: 10},
	}
	...
	svc := service.NewAdminService(adminRepo, userRepo, &mockTransactor{})
...
`
	...
	for _, r := range results {
		assert.Empty(t, r.Error, "row %d should not have error", r.Row)
